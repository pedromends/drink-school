<template>
  ...
  <section class="flex min-h-full">
    <!-- Sidebar -->
    <div
      class="hidden min-h-screen lg:w-[400px] xl:w-[430px] bg-gray-100 lg:flex flex-col justify-between p-6 dark:bg-neutral-950"
    >
      <!-- Header -->
      <div class="flex justify-between items-center">
        ...
        <div class="relative">
          ...
          <div class="absolute top-1/2 end-2.5 -translate-y-1/2">
            <svg
              class="flex-shrink-0 w-3.5 h-3.5 text-gray-500 dark:text-neutral-500"
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
      ...
      <div>
        ...
        <img
          class="dark:hidden"
          src="@/assets/images/authentication-charts.svg"
        ...
        >
          <g clip-path="url(#clip0_399_369933)">
            <path
              ...
              fill="currentColor"
              class="fill-gray-500 dark:fill-neutral-400"
            />
          </g>
          <defs>
    ...
    <div class="grow px-5">
      ...
      >
        ...
        <div>
          <h1
            class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-neutral-200"
          >
        ...
        <div
          class="flex items-center text-xs text-gray-400 uppercase before:flex-[1_1_0%] before:border-t before:border-gray-200 before:me-6 after:flex-[1_1_0%] after:border-t after:border-gray-200 after:ms-6 dark:text-neutral-500 dark:before:border-neutral-700 dark:after:border-neutral-700"
        >
          Or
        </div>
        ...
        <form>
          <div class="space-y-5">
            ...
            <div class="flex space-x-2">
              <input
                type="checkbox"
                class="shrink-0 border-gray-200 w-3.5 h-3.5 mt-[3px] rounded text-blue-600 focus:ring-offset-0 dark:bg-neutral-800 dark:checked:bg-blue-500 dark:border-neutral-700"
                id="hs-pro-dsftac"
              />
              <label
                for="hs-pro-dsftac"
                class="text-sm text-gray-800 ms-1.5 dark:text-neutral-200"
              >
                I accept the
                <a
                  class="inline-flex items-center gap-x-1.5 font-medium text-blue-600 hover:text-blue-700 decoration-2 hover:underline dark:text-blue-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-neutral-600"
                  href="#"
                >
