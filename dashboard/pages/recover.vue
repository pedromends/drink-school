<template>
  ...
  <section class="flex min-h-full">
    <!-- Sidebar -->
    <div
      class="hidden min-h-screen lg:w-[400px] xl:w-[430px] bg-gray-100 lg:flex flex-col justify-between p-6 dark:bg-neutral-800"
    >
      <!-- Header -->
      ...
      >
        ...
        <form>
          <div class="space-y-5">
            ...
            <button
              type="button"
              class="py-2.5 px-3 w-full inline-flex justify-center justify-center items-center gap-x-2 text-start bg-blue-600 border border-blue-600 text-white text-sm font-medium rounded-lg shadow-sm align-middle hover:bg-blue-700 focus:outline-none focus:ring-1 focus:ring-blue-300 dark:focus:ring-blue-500"
            >
              Send email
            </button>
          </div>
